...
class CreateStore extends Component {
    ...
    onSubmit(){
        ...
        axios.post('http://localhost:8080/AddQuantity/', AddQuan)
        ...
        axios.post('http://localhost:8080/Add/', AddProd)
            .then(res => console.log(res.data))
        ...
        axios.post('http://localhost:8080/AddStore/', AddStore)
            .then(res => console.log(res.data))
